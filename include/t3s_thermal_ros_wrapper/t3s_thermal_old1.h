...
struct t3s_thermal_
{
  ...
  _image_height_type image_height;
   ...
   typedef float _temperaturedata_type;
  ...
  typedef boost::shared_ptr< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> const> ConstPtr;

}; // struct t3s_thermal_

typedef ::t3s_thermal_ros_wrapper::t3s_thermal_<std::allocator<void> > t3s_thermal;

typedef boost::shared_ptr< ::t3s_thermal_ros_wrapper::t3s_thermal > t3s_thermalPtr;
typedef boost::shared_ptr< ::t3s_thermal_ros_wrapper::t3s_thermal const> t3s_thermalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator1> & lhs, const ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.frame_num == rhs.frame_num &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> const>
  : FalseType
  { };
...
template <class ContainerAllocator>
struct IsMessage< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> const>
  : TrueType
  { };
...
template <class ContainerAllocator>
struct HasHeader< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> const>
  : TrueType
  { };
...
struct MD5Sum< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> >
{
  ...
  {
    return "066366d01f6a14d7fe6ffa6744b2ce73";
  }

  static const char* value(const ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x066366d01f6a14d7ULL;
  static const uint64_t static_value2 = 0xfe6ffa6744b2ce73ULL;
};
...
struct DataType< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "t3s_thermal_ros_wrapper/t3s_thermal";
  }
...
template<class ContainerAllocator>
struct Definition< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator> >
  {
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::t3s_thermal_ros_wrapper::t3s_thermal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "temperaturedata: ";
    Printer<float>::stream(s, indent + "  ", v.temperaturedata);
  }
};
